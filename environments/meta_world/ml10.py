...
class ML10(gym.Env):
    def __init__(self):
        super(ML10, self).__init__()
        self._benchmark = metaworld.ML10()
        self._kind = 'train'
    ...
    def get_task(self):
        return list(self._classes.keys()).index(self.current_task.env_name)
...
def test_env():
    ...
    class_list = env._classes
    task_list = env._tasks
    print(class_list, task_list)
