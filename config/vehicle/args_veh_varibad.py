...
def get_args(rest_args):
    ...
    parser.add_argument('--precollect_len', type=int, default=1000,
    ...
    parser.add_argument('--sinkhorn_iterations', type=int, default=5, help='')
    parser.add_argument('--num_cluster_updates', type=int, default=3, help='')
    parser.add_argument('--cluster_loss_coeff', type=float, default=100., help='')
