...
def get_args(rest_args):
    ...
    parser.add_argument('--pass_state_to_policy', type=bool, default=True, help='condition policy on state')
    parser.add_argument('--pass_latent_to_policy', type=bool, default=True, help='condition policy on VAE latent')
    parser.add_argument('--pass_belief_to_policy', type=bool, default=False, help='condition policy on ground-truth belief')
    parser.add_argument('--pass_task_to_policy', type=bool, default=False, help='condition policy on ground-truth task description')
    ...
    parser.add_argument('--norm_state_for_policy', type=bool, default=True, help='normalise state input')
    parser.add_argument('--norm_latent_for_policy', type=bool, default=True, help='normalise latent input')
    parser.add_argument('--norm_belief_for_policy', type=bool, default=True, help='normalise belief input')
    parser.add_argument('--norm_task_for_policy', type=bool, default=True, help='normalise task input')
    parser.add_argument('--norm_rew_for_policy', type=bool, default=True, help='normalise rew for RL train')
    parser.add_argument('--norm_actions_pre_sampling', type=bool, default=True, help='normalise policy output')
    parser.add_argument('--norm_actions_post_sampling', type=bool, default=True, help='normalise policy output')
    ...
    parser.add_argument('--policy_anneal_lr', type=bool, default=True)
    ...
    parser.add_argument('--ppo_use_huberloss', type=bool, default=True, help='use huberloss instead of MSE')
    parser.add_argument('--ppo_use_clipped_value_loss', type=bool, default=True, help='clip value loss')
    ...
    parser.add_argument('--policy_use_gae', type=bool, default=True,
                        help='use generalized advantage estimation')
    parser.add_argument('--policy_tau', type=float, default=0.95, help='gae parameter')
    parser.add_argument('--use_proper_time_limits', type=bool, default=False,
    ...
    parser.add_argument('--vae_avg_elbo_terms', type=bool, default=False,
                        help='Average ELBO terms (instead of sum)')
    parser.add_argument('--vae_avg_reconstruction_terms', type=bool, default=False,
    ...
    parser.add_argument('--split_batches_by_task', type=bool, default=False,
                        help='split batches up by task (to save memory or if tasks are of different length)')
    parser.add_argument('--split_batches_by_elbo', type=bool, default=False,
    ...
    # - decoder: rewards
    parser.add_argument('--decode_reward', type=bool, default=False, help='use reward decoder')
    parser.add_argument('--rew_loss_coeff', type=float, default=1.0, help='weight for state loss (vs reward loss)')
    parser.add_argument('--input_prev_state', type=bool, default=False, help='use prev state for rew pred')
    parser.add_argument('--input_action', type=bool, default=False, help='use prev action for rew pred')
    parser.add_argument('--reward_decoder_layers', nargs='+', type=int, default=[32, 32])
    parser.add_argument('--multihead_for_reward', type=bool, default=False,
    ...
    parser.add_argument('--decode_state', type=bool, default=True, help='use state decoder')
    parser.add_argument('--state_loss_coeff', type=float, default=1.0, help='weight for state loss')
    parser.add_argument('--state_decoder_layers', nargs='+', type=int, default=[128, 128])
    ...
    parser.add_argument('--decode_task', type=bool, default=False, help='use task decoder')
    ...
    # for the VAE
    parser.add_argument('--disable_decoder', type=bool, default=False,
                        help='train without decoder')
    parser.add_argument('--disable_stochasticity_in_latent', type=bool, default=False,
                        help='use auto-encoder (non-variational)')
    parser.add_argument('--disable_kl_term', type=bool, default=False,
                        help='dont use the KL regularising loss term')
    parser.add_argument('--decode_only_past', type=bool, default=False,
                        help='only decoder past observations, not the future')
    parser.add_argument('--kl_to_gauss_prior', type=bool, default=False,
                        help='KL term in ELBO to fixed Gaussian prior (instead of prev approx posterior)')

    # combining vae and RL loss
    parser.add_argument('--rlloss_through_encoder', type=bool, default=False,
                        help='backprop rl loss through encoder')
    parser.add_argument('--add_nonlinearity_to_latent', type=bool, default=False,
    ...
    parser.add_argument('--sample_embeddings', type=bool, default=False,
                        help='sample embedding for policy, instead of full belief')

    # for other things
    parser.add_argument('--disable_metalearner', type=bool, default=False,
                        help='Train feedforward policy')
    parser.add_argument('--single_task_mode', type=bool, default=False,
                        help='train policy on one (randomly chosen) environment only')

    # --- ENV ---

    parser.add_argument('--scale_devi_p', type=float, default=0.1, help='None')
    parser.add_argument('--scale_devi_v', type=float, default=0.5, help='None')
    ...
    parser.add_argument('--scale_constraint', type=float, default=2., help='None')
    parser.add_argument('--reward_shift', type=float, default=10., help='None')
    ...
    parser.add_argument('--save_intermediate_models', type=bool, default=True, help='save all models')
    ...
    # general settings
    parser.add_argument('--seed',  nargs='+', type=int, default=[74])
    parser.add_argument('--deterministic_execution', type=bool, default=False,
