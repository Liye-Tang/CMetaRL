...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='Walker2DClusterParams-v0', help='environment to train on')
    ...
    # cluster
    parser.add_argument('--num_prototypes', type=int, default=3, help='the num of the classes: K')
