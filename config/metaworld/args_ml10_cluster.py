...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='ML10-v0', help='environment to train on')
    ...
    parser.add_argument('--encoder_layers_before_gru', nargs='+', type=int, default=[32, 64, 128])
    parser.add_argument('--encoder_gru_hidden_size', type=int, default=128, help='dimensionality of RNN hidden state')
    parser.add_argument('--encoder_layers_after_gru', nargs='+', type=int, default=[128, 64, 32])
    ...
    parser.add_argument('--reward_decoder_layers', nargs='+', type=int, default=[128, 64, 32])
